          ...
          <>
            <Col>
              <h4 className="text-center my-3 pt-3 fw-bold">
                Produktet e {lloji == 'shitje' ? 'Shitjes' : 'Blerjes'}: {shifraPerDetaje}
              </h4>
            </Col>
            <Col>
                  ...
                  <table className="table table-sm table-striped border table-hover text-center">
                    <thead className="table-secondary">
                      <tr className="fs-5">
                        ...
                        <th scope="col">Emertimi i Produktit</th>
                        <th scope="col">Pershkrimi i Produktit</th>
                        <th scope="col">Cmimi per Cope</th>
                        <th scope="col">Sasia {lloji == 'blerje' ? 'e Blerjes' : ''}</th>
