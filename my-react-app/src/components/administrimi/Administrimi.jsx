...
export default function Administrimi() {
  ...
  return (
    <Container className="administrimi-container p-4" >
      <h2 className="mb-4 text-center" style={{ color: '#2A3D4E' }}>{t('Administrimi dhe Menaxhimi')}</h2>
      <hr/>
      <div className="d-flex justify-content-center mb-4">
        ...
        <Button
          ...
          className="mx-2"
        >
          {t('Menaxhimi i Menyrave te Pagesave')}
        </Button>
        <Button
